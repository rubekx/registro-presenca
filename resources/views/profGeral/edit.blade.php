            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class='col-md-5'>
                            {{ Form::select('estado', $estados, $currEstado, array('class' => 'form-control selectpicker', 'data-live-search' => 'true','data-live-search-normalize' => 'true', 'title' => 'Por favor, selecione seu estado ...', 'data-parsley-required' => 'true')) }}
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class='col-md-2' style='margin-top: 5px; text-align: right;'>
                        ...
                        <div class='col-md-5'>
                            {{ Form::select('municipio', $arrayMun, null, array('class' => 'form-control selectpicker', 'data-live-search' => 'true', 'data-live-search-normalize' => 'true','title' => 'Por favor, selecione seu estado ...', 'data-parsley-required' => 'true')) }}
                        </div>
                    </div>
                    <div class="form-group row">
